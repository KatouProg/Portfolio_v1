    ...
    <v-layout row justify-center align-center wrap class="mt-4 pt-2">
      <v-flex xs12 sm12 md6 lg6 xl6>
        ...
        <div class="py-4 subheading font-weight-bold">
          ...
          <span>Chiba,&nbsp;</span>
          <span class="green--text">Japan</span>
        </div>
        <div class="py-4 subheading font-weight-bold">
        ...
        <div class="py-4 subheading font-weight-bold">
          ...
          <span>+81&nbsp;</span>
          <span class="green--text">070 4356 9256</span>
        </div>
        <div class="py-4 subheading font-weight-bold">
      ...
      <v-flex xs12 sm12 md6 lg6 xl6>
        ...
        <form method="POST" action="https://formspree.io/katouprog@gmail.com">
          <v-text-field
            name="name"
            color="green"
  ...
  metaInfo: {
    ...
    meta: [
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        name: "description",
        content:
          "Quentin BUXO's Contact Chiba Japan Freelance Get in Touch ContactMe"
      },
      { charset: "utf-8" },
